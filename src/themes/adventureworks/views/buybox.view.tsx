...
import { AddToWishlistComponent, IWishlistActionErrorResult, 
    AddToCartComponent 
} from '@msdyn365-commerce/components';
import { format, ItemAvailability, 
    // ProductPrice, 
...
import { IAddToCartComponentProps } from './components/addtocart.component';
 ...
 * @returns -- Returns.
 */
const renderAddToCart = (addToCart: IBuyboxAddToCartViewProps, props: IBuyboxViewProps & IBuyboxExtentionProps<IBuyboxData>, setOpen: { (value: React.SetStateAction<boolean>): void; }): JSX.Element => {
    // eslint-disable-next-line @typescript-eslint/naming-convention -- Dependency from Buybox.tsx file
    ...
    return (
        <Node {...ContainerProps}>
            ...
            {shouldShowOutOfStock(buttonProps, false) ?
                <div className={buttonProps.className}><button className='msc-add-to-cart mt-3' onClick={() => { setOpen(o => !o) }}>Notify Me When Available</button></div>
                :
    ...
    return (
        <Module {...ModuleProps}>
            ...
            <Node {...ProductInfoContainerProps}>
                ...
                {/* {renderAddToCartComponent(props, product.result!)} */}
                {/* {!inStockCheck && <button className='msc-add-to-cart mt-3' onClick={() => {setOpen(o => !o)}}>Notify Me When Available</button>} */}
