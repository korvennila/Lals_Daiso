...
import { showAdditionalFields } from '../checkout-store-gift-card.props.autogenerated';
...
export interface IGetFormInput {
    ...
    isPaymentGatewayEnabled: boolean; // New prop for radio button state
    onTogglePaymentGateway(): void; // New handler for radio button
...
export const getForm = (options: IGetFormInput): IForm => {
    const {
        ...
        isPaymentGatewayEnabled, // New prop
        onTogglePaymentGateway, // New handler
        paymentGatewayLabel
    } = options;
