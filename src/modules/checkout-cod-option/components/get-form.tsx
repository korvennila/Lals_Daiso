...
import { ICheckoutCodOptionConfig, ICheckoutCodOptionResources, showAdditionalFields } from '../checkout-cod-option.props.autogenerated';
...
export const getForm = (options: IGetFormInput): IForm => {
    ...
    // const [isCodSelected, setIsCodSelected] = React.useState(false);
    ...
    const handleCODOptionChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        //setIsCodSelected(selectedOption === 'COD');
        setCodSelected();
        handleCodClick();
    };
