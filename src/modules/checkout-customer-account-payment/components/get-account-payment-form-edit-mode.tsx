...
import { Customer, isEmpty } from '@msdyn365-commerce/retail-proxy';
import {
    Alert,
    Button,
    INodeProps,
    NodeTag
    //getLocaleBasedCustomizedPrice, ILocalizedPrice
...
export const getAccountPaymentFormEditMode = (options: IGetAccountPaymentEditViewFormInput): IAccountPaymentEditViewForm => {
    ...
    const handleVoucherInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        handleVoucherIdChange(event.target.value);
    };
