...
export class CheckoutPaymentInstrument extends React.PureComponent<ICheckoutPaymentInstrumentModuleProps> {
    ...
    public render(): JSX.Element | null {
        ...
        const viewProps: ICheckoutPaymentInstrumentViewProps = {
            ...
            paymentGatewayRadio: isEnablePaymentRadioOption ? (
                <div className='ms-checkout-customer-account__payment-gateway'>
                    <input
                        ...
                        checked={this.state.isPaymentGatewayEnabled}
                        onChange={this.onTogglePaymentGateway}
                    />
                    <label htmlFor='PaymentGateway'>
                        {paymentGatewayTitle === '' ? resources.paymentGatewayTitle : paymentGatewayTitle || resources.paymentGatewayTitle}
                    </label>
                </div>
            ) : null
        };
