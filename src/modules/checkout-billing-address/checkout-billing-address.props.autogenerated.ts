 ...
 * ICheckoutBillingAddress contentModule Interface Properties
 * THIS FILE IS AUTO-GENERATED - MANUAL MODIFICATIONS WILL BE LOST
 */

import * as Msdyn365 from '@msdyn365-commerce/core';

export interface ICheckoutBillingAddressConfig extends Msdyn365.IModuleConfig {
...
export interface ICheckoutBillingAddressResources {
...
export interface ICheckoutBillingAddressProps<T> extends Msdyn365.IModule<T> {
    resources: ICheckoutBillingAddressResources;
    config: ICheckoutBillingAddressConfig;
}
