 ...
 * ICustomOrderDetails contentModule Interface Properties
...
export interface ICustomOrderDetailsConfig extends Msdyn365.IModuleConfig {
...
export interface ICustomOrderDetailsProps<T> extends Msdyn365.IModule<T> {
    resources: ICustomOrderDetailsResources;
    config: ICustomOrderDetailsConfig;
}
