...
const BuyboxView: React.FC<IBuyboxViewProps & IBuyboxExtentionProps<IBuyboxData>> = props => {
    ...
    const toggleProductSpecification = () => {
        setIsProductSpecExpanded(!isProductSpecExpanded);
    };
                ...
                <Node {...ProductInfoContainerProps}>
                    ...
                    {rowdata && ArrayExtensions.hasElements(rowdata) ? (
                        <Module {...ProductSpecification}>
                            <Node className='ms-product-specification__heading-container'>
                                <div className='ms-product-specification__heading-text'>{props.productSpecificationTitle}</div>
                                <Button
                                    className={`ms-product-specification__heading-btn ${isProductSpecExpanded ? 'expanded' : 'collapsed'}`}
                                    onClick={toggleProductSpecification}
                                >
                                    <span></span>
                                </Button>
                            </Node>
                            {isProductSpecExpanded && (
