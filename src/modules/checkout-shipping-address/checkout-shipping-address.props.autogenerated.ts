 ...
 * ICheckoutShippingAddress contentModule Interface Properties
 * THIS FILE IS AUTO-GENERATED - MANUAL MODIFICATIONS WILL BE LOST
 */

import * as Msdyn365 from '@msdyn365-commerce/core';

export interface ICheckoutShippingAddressConfig extends Msdyn365.IModuleConfig {
...
export interface ICheckoutShippingAddressResources {
...
export interface ICheckoutShippingAddressProps<T> extends Msdyn365.IModule<T> {
